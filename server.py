...
def make_play(row, column):
    ...
    if game_instance.from_is_not_set and game_instance.to_is_not_set:
        re_draw_current_player_command = make_command("re_draw", ["Sua vez", game_instance.board])
        re_draw_opponent_command = make_command("re_draw", ["Vez do seu adversário", game_instance.board])
